...
<body>
    <div class="prod">
        <div class="prod-cate">
            ...
            <span class="prod-cate-unselect" id="<?= $cate['cateId']?>" onclick="toggleSelectCate('<?= $cate['cateId']?>')"><?= $cate['cateName']?></span>
            <?php endforeach; ?>
        </div>
        <div class="prod-list-right">
            <div class="prod-breadcrumb">
                <div class="prod-breadcrumb-black">
                    <span onclick="link('http://localhost/PharmaDI-Enduser/home.php')">Trang chủ</span>
            ...
            <div class="prod-tag">
                ...
                <span
                    style="padding: 10px 20px; background-color: #EFFAFF; border: 1px solid #0071AF; border-radius: 30px 0; font-size: 12px; color: #0071AF; margin: 5px" id="<?= $tag['tagId']?>"> <?= $tag['tagName']?>
                </span>
                <?php endforeach; ?>
            </div>
            <div class="prod-list">
                ...
                <div class="prod-one-in">
                    ...
                    <div style="display: flex; flex-direction: column; color: 505050">
                        <span style="font-size: 10px; width: max-content; padding: 5px 10px; color: #0071AF; background-color: #EFFAFF; border: 1px solid #0071AF; border-radius: 18px 0; margin-bottom: 8px"><?= $product['tagName'] ?></span>
                        <span style="font-size: 12px; font-weight: 600; overflow: hidden; text-overflow: ellipsis; margin-bottom: 5px; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;"><?= $product['prodName'] ?></span>
                        <span style="font-size: 12px; padding-bottom: 10px"><?= $product['prodUnit'] ?></span>
                        <div style="display: flex; padding-bottom: 10px; align-items: center;">
                            <span style="font-size: 16px; color: #0071AF; font-weight: 600; padding-right: 10px"><?= $product['prodPriceSale'] ?></span>
                            <span style="font-size: 12px; font-weight: 600; text-decoration: line-through; font-weight: 500"><?= $product['prodPrice'] ?></span>
                        </div>
                    </div>
                    <form action="">
